   ...
   <img class="bg-image">
     ...
     <p class="w-50 font fw-bold text-center">{{$topline}}</p>         
         ...
         <div class="mt-5 mb-5 row d-flex w-50 justify-content-between">
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/convenient.png') }}" alt="Computer Science Assignment Help"/>Hassle-Free Order Process</div>
            ...
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/saving.png') }}" alt="Essay Writing Service"/>On-Time Delivery</div>
         </div>
         <div class="mt-5 mb-5 row d-flex w-50 justify-content-between">
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/certificate.png') }}" alt="Literature Review Writing"/>24*7 Service Available</div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/shield.png') }}" alt="Essay Writers"/>Full Privacy</div>
            <div class="col-sm-4 d-flex flex-column align-items-center font"><img class="home-search-icon" src="{{ asset('icons/original.png') }}" alt="computer science assignment help"/>Plagiarism-Free Content </div>
         </div>
      </div>
   </div>
</div>
...
<div class="row v2"  style="width:70%;">
   <div class="col-md-12 my-3">
      <div class="mx-auto">
         ...
         <p class="font">Computer science is very exciting for some students and they do the assignment with all their hearts. But, you also can’t deny that  Computer Science Assignments
