...
<div class="col-md-12 my-3">
   <img class=" bg-image">
      ...
      <div class="col-md-12 mt-5 head-part text-white">
         ...
         <p class="font" style="color: #2e2221;">Make your order and get our assistance now!</p>
   ...
   <div class="col-md-12 font w-50 moretext section ">
      <div class="row">
        ...
        <ul style="margin-left:20px;">
         ...
         <p class="pd_feature">We also offer Online Essay Writing Help if you have written your essay well but are not sure whether the style, format, or format meets the requirements. Just enter this request,  Write My Essay online</strong> to find Essay Sages, and order. We can type an article for you within hours. 
