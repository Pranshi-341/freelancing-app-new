								...
								<div class="tab-pane active" id="messages" role="tabpanel">
									<div class="chat-box-one-side3">
										<div class="media-list media-list-hover">
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/2.jpg')}}" alt="..."></a>
											...
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/3.jpg')}}" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/4.jpg')}}" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/5.jpg')}}" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/6.jpg')}}" alt="..."></a>
											  <div class="media-body">
												<p>
											...
											<div class="media">
											  <a class="align-self-center mr-0" href="#"><img class="avatar avatar-lg" src="{{asset('/admin/images/avatar/7.jpg')}}" alt="..."></a>
											  <div class="media-body">
												<p>
										...
										<div class="media-list media-list-hover">
											...
											<div class="media py-10 px-0 align-items-center">
											  <a class="avatar avatar-lg status-danger" href="#">
												<img src="{{asset('/admin/images/avatar/2.jpg')}}" alt="...">
											  </a>
											  <div class="media-body">
												<p class="font-size-16">
											...
											<div class="media py-10 px-0 align-items-center">
											  <a class="avatar avatar-lg status-warning" href="#">
												<img src="{{asset('/admin/images/avatar/3.jpg')}}" alt="...">
											  </a>
											  <div class="media-body">
												<p class="font-size-16">
											...
											<div class="media py-10 px-0 align-items-center">
											  <a class="avatar avatar-lg status-primary" href="#">
												<img src="{{asset('/admin/images/avatar/4.jpg')}}" alt="...">
											  </a>
											  <div class="media-body">
												<p class="font-size-16">
							  ...
							  <div class="box-header">
								<div class="media align-items-top p-0">
								  <a class="avatar avatar-lg status-success mx-0" href="#">
									<img src="{{asset('/admin/images/avatar/2.jpg')}}" class="rounded-circle" alt="...">
								  </a>
								  ...
								  <div class="chat-box-one2">
									  <div class="card d-inline-block mb-3 float-left mr-2 no-shadow bg-lighter max-w-p80">
										...
										<div class="card-body">
											<div class="d-flex flex-row pb-2">
												<a class="d-flex" href="#">
													<img alt="Profile" src="{{asset('/admin/images/avatar/1.jpg')}}" class="avatar mr-10">
												</a>
												<div class="d-flex flex-grow-1 min-width-zero">
													<div class="m-2 pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between">
														<div class="min-width-zero">
															<p class="mb-0 font-size-16 text-dark">Sarah Kortney</p>
														</div>
													</div>
												</div>
											</div>
									  ...
									  <div class="card d-inline-block mb-3 float-right mr-2 bg-primary max-w-p80">
										...
										<div class="card-body">
											<div class="d-flex flex-row pb-2">
												<a class="d-flex" href="#">
													<img alt="Profile" src="{{asset('/admin/images/avatar/2.jpg')}}" class="avatar mr-10">
												</a>
												<div class="d-flex flex-grow-1 min-width-zero">
													<div class="m-2 pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between">
														<div class="min-width-zero">
															<p class="mb-0 font-size-16">Mimi Carreira</p>
														</div>
													</div>
												</div>
											</div>
