...
<div class="row">
   ...
   <img class="bg-image">
      ...
      <div class="col-md-12 mt-5 head-part text-white">
         ...
         <p class="w-50 font bold text-center" style="line-height:inherit; font-size:20px;">Where Our Acclaimed Client’s Assignments And Tasks Are
...
So, don't delay and get your professional help now!
         ...
         <p class="pd_feature  font-large font">No matter whether you need an essay, research paper, Casual Essay, Narrative Paper, or some other kind of assistance, with Essay Sages, you can easily afford it. On placing Online Essays Order with us, this is what you will get:
              ...
              <p class=" font-large font"> We provide the best and most affordable prices to our customers for Writing Essays Service. The lowest per-page price is just $10. Apart from saving you time and effort, we are also giving generous discounts to save you money. You give us time to complete the project, we will give you a discount accordingly. What’s more, you require!
         ...
         <p class="pd_feature  font-large font">We are considered one of the best Essay writing Service companies that delivered high-quality essay writing work to customers at a given time.
...
Hire an Essay Sages writing expert today!
         ...
         <p class="pd_feature  font-large font">When it comes to Essay Sages, you will never be dissatisfied with our Online Writing Service. We have experts who are experienced in the respective field and submit the work after proper checking.
...
In any case, if you find the whole task inappropriate, which is impossible, you can ask for a refund within 7 days of submitting the task.
         ...
         <p class="pd_feature  font-large font">At Essay Sages, we offer a variety of services that includes Essay Writing, Books Reviews, Case-Studies, and Dissertation. Curious to know more about our services? You can consult with our customer support executives.</p>
          <h3 class="text-center pd_feature"> How To Reach Out To Essay Writer Online Hassle-Free?</h3>
         <p class="pd_feature  font-large font">Need someone professionals who can finish the pending assignment task for you? You can end your search with our expert essay writers. Simply, visit Essay Sages and say “Write My Paper” and your task will be completed in the given time frame.
         Here is how you can avail of our Easy Essay Writing Service:
         </p>
         <ul style="margin-left:20px;">
            <li><h5>Create a Personal Account</h5></li>
            <p class=" font-large font">It is very easy to join Essay Sages. You just need to submit some of your information with us like your email id or phone number. Once verified, you are all set to enjoy our Essay Services Online.</p>
            <li><h5>Tell Us Your Requirements</h5></li>
            <p class=" font-large font">If you have set up the account successfully, you can place the order right from the dashboard. It may take a few seconds to fill up the form. Submit the form and then tell us about your requirements.</p>
            <li><h5>Writer Essay For Me</h5></li>
            <p class=" font-large font">You can then check out the database of all of our professionals and select the one that fits your requirement. Before hiring a writing expert, don’t forget to check their ratings, success rate, and customer feedback. You can also write “Paying Someone To Write Papers” to the customer support of Essay Sages and we will assign one of our experts to you.</p>
            <li><h5>What’s Your Last Minute Requirement?</h5></li>
            <p class=" font-large font">Don’t need to be worried if you have forgotten to mention something necessary. Use our chat feature to contact our chosen writing expert and then pass on your requirements. Our expert will go through your comments and complete the task based on them.</p>
            <li><h5>Keep in Touch With Our Professional Paper Writers</h5></li>
            <p class=" font-large font">If you are a bit worried about whether your project is going well or not, you can keep in touch with the expert through our chat feature. In this way, you can easily keep an eye on every stage of the project and ask for necessary changes.</p>
            <li><h5> Professional Work Done</h5></li>
            <p class=" font-large font">Once the work is done, you will receive a notification in your mail. You can then download the final draft and go through it. Ensure that our writer has followed your instructions. If you are completely satisfied, you can complete the order and Pay For Essay Orders.</p>   
         </ul>
         <h2  class="text-center pd_feature">Are You a Professional Writer?</h2>
         <p class="pd_feature  font-large font">We are always in search of an Essay Writing Service expert to join the team of Essay Sages.</p>   
